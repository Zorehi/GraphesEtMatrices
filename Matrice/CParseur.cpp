...
CMatricePlus<double> CParseur::PARLirefichier(const char * pcNomFichier)
{
	...
	//Je considere size_t comme un unsigned int pour le nommage de la variable, � voir avec le prof
	size_t uiLongueur;
	size_t uiLongueur2;
	...
	pcTypeMatrice[uiLongueur2] = '\0'; //Ajoute le caractere de fin de chaine � pcTypeMatrice
